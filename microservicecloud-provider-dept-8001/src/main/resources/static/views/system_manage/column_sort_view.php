...
<script>
    ...
    function loadSystemDefault(){
        ...
        var columnModel = tencheer.getIframe(frameId).$("#" + gridId).jqGrid('getGridParam', 'colModel');
    ...
    function AcceptClick() {
     if (frameId.length==0) frameId=tencheer.tabiframeId();
        ...
        var columnJson =tencheer.getIframe(frameId).$("#" + gridId).jqGrid('getGridParam', 'colModel');
        
        var rowJson = tencheer.getIframe(frameId).$("#" + gridId).jqGrid('getRowData');
        ...
        $('#executeexcel').remove();
        var $form = $("<form id='executeexcel' method='post' action='" + top.contentPath + "/system_manage/excel_export_manage/ExecuteExportExcel' style='display:none;'>");
