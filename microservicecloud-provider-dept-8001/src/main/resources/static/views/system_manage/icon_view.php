...
<head>
    ...
    <link href="/statics/styles/font-awesome.min.css?v=20160912" rel="stylesheet" />
...
<div id="icons">
    <section id="new">
        ...
        <div class="row fontawesome-icon-list">
            <div class="fa-hover filter-icon"><a ids="icon/address-book"><i class="fa fa-address-book"></i>address-book</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/address-book-o"><i class="fa fa-address-book-o"></i>address-book-o</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/address-card"><i class="fa fa-address-card"></i>address-card</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/address-card-o"><i class="fa fa-address-card-o" ></i>address-card-o</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/bandcamp"><i class="fa fa-bandcamp" ></i>bandcamp</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/bath"><i class="fa fa-bath" ></i>bath</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/bath"><i class="fa fa-bathtub" ></i>bathtub <span class="text-muted">(alias)</span></a></div>
            <div class="fa-hover filter-icon"><a ids="icon/id-card"><i class="fa fa-drivers-license" ></i>drivers-license <span class="text-muted">(alias)</span></a></div>
            <div class="fa-hover filter-icon"><a ids="icon/id-card-o"><i class="fa fa-drivers-license-o" ></i>drivers-license-o <span class="text-muted">(alias)</span></a></div>
            <div class="fa-hover filter-icon"><a ids="icon/eercast"><i class="fa fa-eercast" ></i>eercast</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/envelope-open"><i class="fa fa-envelope-open" ></i>envelope-open</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/envelope-open-o"><i class="fa fa-envelope-open-o" ></i>envelope-open-o</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/etsy"><i class="fa fa-etsy" ></i>etsy</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/free-code-camp"><i class="fa fa-free-code-camp" ></i>free-code-camp</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/grav"><i class="fa fa-grav" ></i>grav</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/handshake-o"><i class="fa fa-handshake-o" ></i>handshake-o</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/id-badge"><i class="fa fa-id-badge" ></i>id-badge</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/id-card"><i class="fa fa-id-card" ></i>id-card</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/id-card-o"><i class="fa fa-id-card-o" ></i>id-card-o</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/imdb"><i class="fa fa-imdb" ></i>imdb</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/linode"><i class="fa fa-linode" ></i>linode</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/meetup"><i class="fa fa-meetup" ></i>meetup</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/microchip"><i class="fa fa-microchip" ></i>microchip</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/podcast"><i class="fa fa-podcast" ></i>podcast</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/quora"><i class="fa fa-quora" ></i>quora</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/ravelry"><i class="fa fa-ravelry" ></i>ravelry</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/bath"><i class="fa fa-s15" ></i>s15 <span class="text-muted">(alias)</span></a></div>
            <div class="fa-hover filter-icon"><a ids="icon/shower"><i class="fa fa-shower" ></i>shower</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/snowflake-o"><i class="fa fa-snowflake-o" ></i>snowflake-o</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/superpowers"><i class="fa fa-superpowers" ></i>superpowers</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/telegram"><i class="fa fa-telegram" ></i>telegram</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/thermometer-full"><i class="fa fa-thermometer" ></i>thermometer <span class="text-muted">(alias)</span></a></div>
            <div class="fa-hover filter-icon"><a ids="icon/thermometer-empty"><i class="fa fa-thermometer-0" ></i>thermometer-0 <span class="text-muted">(alias)</span></a></div>
            <div class="fa-hover filter-icon"><a ids="icon/thermometer-quarter"><i class="fa fa-thermometer-1" ></i>thermometer-1 <span class="text-muted">(alias)</span></a></div>
            <div class="fa-hover filter-icon"><a ids="icon/thermometer-half"><i class="fa fa-thermometer-2" ></i>thermometer-2 <span class="text-muted">(alias)</span></a></div>
            <div class="fa-hover filter-icon"><a ids="icon/thermometer-three-quarters"><i class="fa fa-thermometer-3" ></i>thermometer-3 <span class="text-muted">(alias)</span></a></div>
            <div class="fa-hover filter-icon"><a ids="icon/thermometer-full"><i class="fa fa-thermometer-4" ></i>thermometer-4 <span class="text-muted">(alias)</span></a></div>
            <div class="fa-hover filter-icon"><a ids="icon/thermometer-empty"><i class="fa fa-thermometer-empty" ></i>thermometer-empty</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/thermometer-full"><i class="fa fa-thermometer-full" ></i>thermometer-full</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/thermometer-half"><i class="fa fa-thermometer-half" ></i>thermometer-half</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/thermometer-quarter"><i class="fa fa-thermometer-quarter" ></i>thermometer-quarter</a></div>
            <!--<div class="fa-hover filter-icon"><a ids="icon/thermometer-three-quarters"><i class="fa fa-thermometer-three-quarters"></i>thermometer-three-quarters</a></div>-->
            <div class="fa-hover filter-icon"><a ids="icon/window-close"><i class="fa fa-times-rectangle" ></i>times-rectangle <span class="text-muted">(alias)</span></a></div>
            <div class="fa-hover filter-icon"><a ids="icon/window-close-o"><i class="fa fa-times-rectangle-o" ></i>times-rectangle-o <span class="text-muted">(alias)</span></a></div>
            <div class="fa-hover filter-icon"><a ids="icon/user-circle"><i class="fa fa-user-circle" ></i>user-circle</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/user-circle-o"><i class="fa fa-user-circle-o" ></i>user-circle-o</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/user-o"><i class="fa fa-user-o"></i>user-o</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/address-card"><i class="fa fa-vcard" ></i>vcard <span class="text-muted">(alias)</span></a></div>
            <div class="fa-hover filter-icon"><a ids="icon/address-card-o"><i class="fa fa-vcard-o" ></i>vcard-o <span class="text-muted">(alias)</span></a></div>
            <div class="fa-hover filter-icon"><a ids="icon/window-close"><i class="fa fa-window-close" ></i>window-close</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/window-close-o"><i class="fa fa-window-close-o" ></i>window-close-o</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/window-maximize"><i class="fa fa-window-maximize" ></i>window-maximize</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/window-minimize"><i class="fa fa-window-minimize" ></i>window-minimize</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/window-restore"><i class="fa fa-window-restore" ></i>window-restore</a></div>
            <div class="fa-hover filter-icon"><a ids="icon/wpexplorer"><i class="fa fa-wpexplorer" ></i>wpexplorer</a></div>
...
<input name="__RequestVerificationToken" type="hidden" value="D2lSfAAtSW5A_tazxa2mrUNcCFUPXzPMpuMbnKGAQ2KRqjzIoehsUWfpkHyMlyAVFLahzElC-moOZOShPvE_O3728LTLJU0tYCr6r9ct_dMBj5D1AhlmIREUTdDBNgL1Qit7wNPGVNqIGKWrpINgLZwlMgYieV9-sM0nn035nzw1" />
</body>
</html>
<script>
    (function ($, tencheer) {
