                ...
                function(window, noGlobal) {
                    ...
                    jQuery
                            .extend({
                                ...
                                proxy : function(fn, context) {
                                    ...
                                    proxy = function() {
                                        return fn.apply(context || this, args.concat(slice
                                                .call(arguments)));
                                    };
                    ...
                    (function(window) {
                        ...
                        setDocument = Sizzle.setDocument = function(node) {
                            ...
                            sortOrder = hasCompare ? function(a, b) {
                                ...
                                if (compare
                                    ...
                                    return sortInput ? (indexOf(sortInput, a) - indexOf(sortInput,
                                            b)) : 0;
                                }
                        ...
                        Sizzle.attr = function(elem, name) {
                            ...
                            val = fn && hasOwn.call(Expr.attrHandle, name.toLowerCase()) ? fn(elem,
                                    name, !documentIsHTML) : undefined;

                            return val !== undefined ? val
                                    : support.attributes || !documentIsHTML ? elem
                                                ...
                                                if (parent) {
                                                    ...
                                                    if (forward && useCache) {
                                                        ...
                                                        while ((node = ++nodeIndex && node
                                                            ...
                                                            // When found, cache indexes on `parent`
                                                            // and break
                            ...
                            return markFunction(function(seed, results, context, xml) {
                                ...
                                if (seed) {
                                    ...
                                    matcherOut = condense(matcherOut === results ? matcherOut
                                            .splice(preexisting, matcherOut.length) : matcherOut);
                                    if (postFinder) {
                        ...
                        function matcherFromTokens(tokens) {
                            ...
                            }, implicitRelative, true), matchAnyContext = addCombinator(function(
                                    elem) {
                        ...
                        select = Sizzle.select = function(selector, context, results, seed) {
                                ...
                                while (i--) {
                                    ...
                                    if ((find = Expr.find[type])) {
                                        ...
                                        if ((seed = find(token.matches[0].replace(runescape,
                                                funescape), rsibling.test(tokens[0].type)
                                                && testContext(context.parentNode) || context))) {
                            ...
                            // above
                            (compiled || compile(selector, match))(seed, context, !documentIsHTML,
                    ...
                    jQuery.filter = function(expr, elems, not) {
                        ...
                        return elems.length === 1 && elem.nodeType === 1 ? jQuery.find
                                .matchesSelector(elem, expr) ? [ elem ] : [] : jQuery.find.matches(
                                expr, jQuery.grep(elems, function(elem) {
                            ...
                            if (match && (match[1] || !context)) {
                                ...
                                if (match[1]) {
                                    ...
                                    jQuery.merge(this, jQuery.parseHTML(match[1], context
                                            && context.nodeType ? context.ownerDocument || context
                                            : document, true));
                    ...
                    jQuery
                            .extend({
                                ...
                                // Not public - generate a queueHooks object, or return the current
                                // one
                    ...
                    jQuery.event = {
                        ...
                        trigger : function(event, data, elem, onlyHandlers) {
                            ...
                            var i, cur, tmp, bubbleType, ontype, handle, special, eventPath = [ elem
                                    || document ], type = hasOwn.call(event, "type") ? event.type
                                    : event, namespaces = hasOwn.call(event, "namespace") ? event.namespace
                                    .split(".")
                                    : [];
                                    ...
                                    function(orig, fix) {
                                        jQuery.event.special[orig] = {
                                            ...
                                            handle : function(event) {
                                                ...
                                                // For mousenter/leave call the handler if related
                                                // is outside the target.
                                                // NB: No relatedTarget if the mouse left/entered
                                                // the browser window
                                                if (!related
                                    ...
                                    for (; i < l; i++) {
                                        ...
                                        if (elem || elem === 0) {
                                            ...
                                            if (jQuery.type(elem) === "object") {
                                                ...
                                                jQuery
                                                        .merge(nodes, elem.nodeType ? [ elem ]
                                                                : elem);
                    ...
                    jQuery.fn
                            .extend({
                                text : function(value) {
                                    return access(this, function(value) {
                                        return value === undefined ? jQuery.text(this) : this
                                                .empty().each(
                                                        function() {
                                                            if (this.nodeType === 1
                                                                    || this.nodeType === 11
                                ...
                                replaceWith : function() {
                                    ...
                                    // arguments)
                                    return arg && (arg.length || arg.nodeType) ? this : this
                                            .remove();
                                },
                                ...
                                domManip : function(args, callback) {
                                    ...
                                    if (l) {
                                        ...
                                        if (first) {
                                            ...
                                            // Use the original fragment for the last item instead
                                            // of the first because it can end up
                    ...
                    function actualDisplay(name, doc) {
                        ...
                        // Use of this method is a temporary fix (more like optimization) until
                                    ...
                                    .extend(
                                            support,
                                            {
                                                ...
                                                reliableMarginRight : function() {
                                                    ...
                                                    var ret, marginDiv = div.appendChild(document
                                                            .createElement("div"));
                            ...
                            .extend({
                                ...
                                style : function(elem, name, value, extra) {
                                    ...
                                    if (value !== undefined) {
                                        ...
                                        // If a number, add 'px' to the (except for certain CSS
                                        // properties)
                                        ...
                                        // If a hook was provided, use that value, otherwise just
                                        ...
                                        // If a hook was provided get the non-computed value from
                                        // there
                                        if (hooks
                                                && "get" in hooks
                        ...
                        jQuery.cssHooks[name] = {
                            get : function(elem, computed, extra) {
                                if (computed) {
                                    ...
                                    return rdisplayswap.test(jQuery.css(elem, "display"))
                                            && elem.offsetWidth === 0 ? jQuery.swap(elem, cssShow,
                                            function() {
                            ...
                            set : function(elem, value, extra) {
                                ...
                                return setPositiveNumber(elem, value, extra ? augmentWidthOrHeight(
                                        elem, name, extra, jQuery.css(elem, "boxSizing", false,
                    ...
                    Tween.prototype = {
                        ...
                        cur : function() {
                            ...
                            return hooks && hooks.get ? hooks.get(this) : Tween.propHooks._default
                                    .get(this);
                        },
                    ...
                    function defaultPrefilter(elem, props, opts) {
                        ...
                        if (elem.nodeType === 1 && ("height" in props || "width" in props)) {
                            ...
                            checkDisplay = display === "none" ? data_priv.get(elem, "olddisplay")
                        ...
                        for (prop in props) {
                            ...
                            if (rfxtypes.exec(value)) {
                                ...
                                // Any non-fx value stops us from restoring the original display
                                // value
                            } else {
                                display = undefined;
                            }
                    ...
                    jQuery.fn
                            .extend({
                                ...
                                animate : function(prop, speed, easing, callback) {
                                    var empty = jQuery.isEmptyObject(prop), optall = jQuery.speed(
                                            speed, easing, callback), doAnimation = function() {
                                    ...
                                    return this
                                            .each(function() {
                                                var dequeue = true, index = type != null && type
                                                        + "queueHooks", timers = jQuery.timers, data = data_priv
                                                        .get(this);
                    ...
                    jQuery.each([ "toggle", "show", "hide" ], function(i, name) {
                        ...
                        jQuery.fn[name] = function(speed, easing, callback) {
                            return speed == null || typeof speed === "boolean" ? cssFn.apply(this,
                                    arguments) : this.animate(genFx(name, true), speed, easing,
                                    callback);
                        };
                    });
                                    ...
                                    tabIndex : {
                                        get : function(elem) {
                                            return elem.hasAttribute("tabindex")
                                                    || rfocusable.test(elem.nodeName) || elem.href ? elem.tabIndex
                                                    : -1;
                                        }
                                    }
                                }
                                    ...
                                    return this
                                            .each(function() {
                                                if (type === "string") {
                                                    ...
                                                    // passed `false`,
                                                    // then remove the whole classname (if there was
                                    ...
                                    select : {
                                        get : function(elem) {
                                            ...
                                            for (; i < max; i++) {
                                                ...
                                                // IE6-9 doesn't update selected after form reset
                                                // (#2551)
                            ...
                            set : function(elem, value) {
                                if (jQuery.isArray(value)) {
                                    return (elem.checked = jQuery
                                            .inArray(jQuery(elem).val(), value) >= 0);
                                }
                            }
                        };
                        if (!support.checkOn) {
                     ...
                     * transport - AFTER param serialization (s.data is a string if s.processData is
                    ...
                    /*
                     * Transports bindings 1) key is the dataType 2) the catchall symbol "*" can be
                     * used 3) selection will start with transport dataType and THEN go to "*" if
                     * needed
                     */
                    transports = {},
                            ...
                            .extend({
                                ...
                                ajax : function(url, options) {
                                    ...
                                    s.url = ((url || s.url || ajaxLocation) + "")
                                            .replace(rhash, "").replace(rprotocol,
                                                    ajaxLocParts[1] + "//");
                                    ...
                                    function done(status, nativeStatusText, responses, headers) {
                                        ...
                                        if (isSuccess) {
                                            ...
                                            // Extract error from statusText and normalize for
                                            // non-aborts
                                            error = statusText;
                                        ...
                                        return function() {
                                            if (callback) {
                                                ...
                                                if (type === "abort") {
                                                    ...
                                                    complete(xhrSuccessStatus[xhr.status]
                                                            || xhr.status, xhr.statusText,
                                                    // Support: IE9
                            ...
                            jQuery.ajax({
                                ...
                                data : params
                                    ...
                                    function(responseText) {
                                        ...
                                        // If a selector was specified, locate the right elements in
                                        // a dummy div
                    ...
                    jQuery.fn.extend({
                        ...
                        position : function() {
                            ...
                            if (jQuery.css(elem, "position") === "fixed") {
                                ...
                                parentOffset.top += jQuery.css(offsetParent[0], "borderTopWidth",
                                        true);
                        ...
                        offsetParent : function() {
                            return this.map(function() {
                                ...
                                while (offsetParent
                                        && (!jQuery.nodeName(offsetParent, "html") && jQuery.css(
                    ...
                    jQuery.each([ "top", "left" ], function(i, prop) {
                        jQuery.cssHooks[prop] = addGetHookIf(support.pixelPosition, function(elem,
                                computed) {
                            if (computed) {
