...
function setFormPrint(result){
	...
	for(var i=0;i<result.length;i++){
		...
		//	tableBodyHtml += "<table width='100%' style='table-layout:fixed' class='table table-bordered table-hover'>";
			...
			tableBodyHtml += "  <th width='28%' style='border-left:1px solid #000000;border-top:1px solid #000000'>派工单号</br>生产子查询号(成品名称)</th>";
			tableBodyHtml += "  <th width='16%' style='border-left:1px solid #000000;border-top:1px solid #000000'>产品编码</br>产品名称</br>图号尺寸</th>";
...
//				tableBodyHtml += "  </tr></table>";
				...
				tableBodyHtml += "  <th width='9%' style='border-left:1px solid #000000;border-top:1px solid #000000'>生产订单号</br>工作中心</th>";
				tableBodyHtml += "  <th width='28%' style='border-left:1px solid #000000;border-top:1px solid #000000'>派工单号</br>生产子查询号(成品名称)</th>";
				tableBodyHtml += "  <th width='16%' style='border-left:1px solid #000000;border-top:1px solid #000000'>产品编码</br>产品编码</br>图号尺寸</th>";
...
//		}else {// 非下料件
			...
			tableBodyHtml += "  <td width='28%' style='border-left:1px solid #000000;border-top:1px solid #000000'>"+result[i].dispatchingnumber+"</br>"+result[i].productionsearchno+"("+result[i].topproductorname+")"+result[i].parentdrawcode+"</td>";
			tableBodyHtml += "  <td width='16%' style='border-left:1px solid #000000;border-top:1px solid #000000'>"+result[i].productorcode+"</br>"+result[i].productordesc+"</br>"+drawcode+""+plength+""+"</td>";
