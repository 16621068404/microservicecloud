...
var initTable = function() {
	var table = $('#contractDataTable')
			.DataTable(
					{
						"ajax" : '../../../'+ln_project+'/contract?method=queryContractByConditons&contracttype=2',
						"iDisplayLength" : "8",
						'bPaginate' : true,
						"bDestory" : true,
						"bRetrieve" : true,
...
//	$("input[name=contracttype]:checked").val();
	...
	$('input:radio[name="contracttype"]').change( function(){
		...
		com.leanway.initSelect2("#companionid", "../../../"+ln_project+"/business?method=queryCompanionBySelect2&contracttype="+$("input[name=contracttype]:checked").val(), "搜索合作伙伴");
...
var searchContract = function () {
	...
	oTable.ajax.url("../../../"+ln_project+"/contract?method=queryContractByConditons&contracttype=2&searchValue=" + searchVal+"&checkstatus="+checkstatus).load();
}
