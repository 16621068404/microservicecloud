...
function (a, b) {
    ...
    f.pt.vessel = function (a, b) {
        ...
        function () {
            ...
            var Content_IsClose = '';
            if (e.type[f.type] == "iframe" && 1==2) {
                Content_IsClose = '<div style="float: left;padding-bottom:20px;padding-left:15px;-moz-user-select: none;-webkit-user-select: none;-ms-user-select: none;-khtml-user-select: none;user-select: none;"><input checked="checked" type="checkbox" id="IsdialogClose" style="vertical-align: middle;margin-bottom:2px;" /><label style=";padding-left:5px;cursor:pointer" for="IsdialogClose">确认并关闭</label></div>';
            }
...
//        console.log("layer.getFrameIndex:"+$("#"+a).attr("times"));
