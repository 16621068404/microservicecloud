...
//                    tencheer.Loading(false);
                ...
                if (re_records == 0 || re_records == null) {
                    $jqgrid_bdiv.append('<div class="jqgridNotdata"></div>');
            ...
            setPager = function (pgid, tp) {
                ...
                if (ts.p.pgbuttons === true) {
                    ...
                    pgl += "<td id='" + po[0] + "' class='ui-pg-button ui-corner-all'><span class='ui-icon-seek-first'><i class=\"fa fa-fast-backward\"></i></span></td>";
                    pgl += "<td id='" + po[1] + "' class='ui-pg-button ui-corner-all'><span class='ui-icon-seek-prev'><i class=\"fa fa-backward\"></i></span></td>";
                    pgl += pginp !== "" ? sep + pginp + sep : "";
                    pgl += "<td id='" + po[2] + "' class='ui-pg-button ui-corner-all'><span class='ui-icon-seek-next'><i class=\"fa fa-forward\"></i></span></td>";
                    pgl += "<td id='" + po[3] + "' class='ui-pg-button ui-corner-all'><span class='ui-icon-seek-end'><i class=\"fa fa-fast-forward\"></i></span></td>";
...
//                var grid_id=$.jgrid.jqID(ts.p.id);
//                if (ts.p.colModel[i].name=="rn"){thead +="<span id='frozencolumnstate' onclick='tencheer.SetColumnFrozen("+$.jgrid.jqID(ts.p.id)+")' class='fa fa-lock' style='font-size:16px;color:#a0a3a7;cursor:Pointer;margin-top:4px'></span>";}
...
//                .append($('<div style="position:relative;' + (isMSIE && $.jgrid.msiever() < 8 ? "height:0.01%;" : "") + '"></div>').append(this))
        ...
        filterToolbar: function (p) {
            ...
            return this.each(function () {
                ...
                $.each($t.p.colModel, function (ci) {
                    ...
                    var th = $("<th role='columnheader' class='ui-state-default ui-th-column ui-th-" + $t.p.direction + "'></th>");
                    var thd = $("<div style='position:relative;height:auto;padding-right:0.3em;padding-left:0.3em;'></div>");
                    if (iColNum == 1) { thd = $("<div style='position:relative;height:auto;padding-right:0.3em;padding-left:0.3em;'><span class=\"fa fa-search\" onclick=\"search()\" style=\"font-size:14px;color:gray\"></span></div>");  }
                    var stbl = $("<table class='ui-search-table' cellspacing='0'><tr><td class='ui-search-oper'></td><td class='ui-search-input'></td><td class='ui-search-clear' style='display:none'></td></tr></table>");
                    ...
                    stbl = $("<table class='ui-search-table' cellspacing='0'><tr><td class='ui-search-oper'></td><td class='ui-search-input'></td><td class='ui-search-clear' style='display:none'></td></tr></table>");
                    if (this.hidden === true) { $(th).css("display", "none"); }
                    this.search = this.search === false ? false : true;
                    if (this.stype === undefined) { this.stype = 'text'; }
                    soptions = $.extend({}, this.searchoptions || {});
            ...
            return this.each(function () {
                ...
                if (findnav) {
                    ...
                    if (p.buttonicon.toString().toUpperCase() === "NONE") {
                        ...
                        $(tbd).addClass('ui-pg-button ui-corner-all').append("<div class='ui-pg-div'><span class='" + p.buttonicon+ "' style='"+p.style + "'></span>" + p.caption + "</div>");
                    }
        ...
        editCell: function (iRow, iCol, ed) {
            return this.each(function () {
                ...
                if (cm.editable === true && ed === true && !cc.hasClass("not-editable-cell")) {
                    ...
                    $("input",cc).bind("focus",function(){this.select();});//zzj
