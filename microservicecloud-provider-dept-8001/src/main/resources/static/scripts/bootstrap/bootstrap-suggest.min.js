...
function(a) {
    ...
    function e(a, b, c) {
        if (b.is(":visible")) {
            c.autoDropup && setTimeout(function() {
                ...
                t.height() + t.scrollTop() - a.offset().top < b.height() && a.offset().top > b.height() + t.scrollTop() ? c.addClass("dropup") : c.removeClass("dropup")
            },
            10);
            var d = {};
            ...
            u && !c.showBtn && (b.parents(".input-group").hasClass("dropup") ? (d.top = "auto", d.bottom = a.parent().height()) : (d.top = a.parent().height(), d.bottom = "auto")),
    ...
    function m(a, b, c) {
        ...
        m = 0,
        n = ['<table class="table table-condensed table-bordered  table-sm" style="margin:0">'];
        ...
        if (c._lastData = b, c.showHeader) {
            n.push("<thead bgcolor='#f5f6fa'><tr>");
            for (g in o[0]) k(g, c) && (n.push("<th>", c.effectiveFieldsAlias[g] || g, 0 === m ? "": "", "</th>"), m++);
//             for (g in o[0]) k(g, c) && (n.push("<th>", c.effectiveFieldsAlias[g] || g, 0 === m ? "(" + d + ")": "", "</th>"), m++);
    ...
    var s, t = a(window),
    u = !!window.ActiveXObject || "ActiveXObject" in window,
    v = navigator.userAgent.match(/Chrome\/(\d+)/);
    v && (v = Number(v[1])),
    s = u || v > 51;
    var w = {
        url: null,
        ...
        listAlign: "left",
        listHoverStyle: "background: #6d9eeb; color:#000",
        listHoverCSS: "jhover",
        clearable: !1,
        keyLeft: 37,
        keyUp: 38,
    ...
    x = {
        init: function(b) {
            ...
            j.each(function() {
                ...
                return i(l, o, b) ? (b.showBtn || l.css("border-radius", "0px").parents(".input-group:eq(0)").css("width", "100%").find(".btn:eq(0)").hide(), l.removeClass("disabled").prop("disabled", !1).attr("autocomplete", "off"), o.css(b.listStyle), b.inputBgColor || (b.inputBgColor = l.css("background-color")), l.on("keydown",
                function(a) {
                    var e, f;
                    if (o.is(":visible")) {
                ...
                function(c) {
                    var d;
                    return~a.inArray(c.keyCode, [b.keyLeft,b.keyDown, b.keyUp, b.keyEnter]) ? (l.val(l.val()), void f(l, b)) : (c.keyCode && f(l, b), clearTimeout(k), void(k = setTimeout(function() {
                        d = l.val(),
                        a.trim(d) && d === l.attr("alt") || (l.attr("alt", d), b.multiWord && (d = d.split(b.separator).reverse()[0]), (d.length || b.allowNoKeyword) && b.fnGetData(a.trim(d), l, m, b))
                    },
                    300)))
                }).on("focus",
                function() {
    ...
    a.fn.bsSuggest = function(b) {
        if ("string" == typeof b && x[b]) {
            var c = !0;
            return this.each(function() {
                if (!a(this).data("bsSuggest")) return c = !1
            }),
            c || "init" === b || "version" === b ? x[b].apply(this, [].slice.call(arguments, 1)) : this
        }
