...
//                                   this.$element.html($(e.currentTarget).attr('data-key'));
////                                   console.log(this.$element.parent().parent().children().eq(3));
//                                   (this.$element.parent().parent().children()).eq(3).html($(e.currentTarget).attr('data-id'));
//                                   
                                   this.options.callback(this.$element,$(e.currentTarget));
                                   this.hide();
                                },
				hide:function(event){
				...
				initTargetEvents:function(){
					...
					this.$target.find('.close').off('click').on('click', $.proxy(this.hide,this));
                                        this.$target.find('.poprow').off('click').on('click', $.proxy(this.setvalue,this));
				},
				/* utils methods */
				...
				getTargetPositin:function(elementPos,placement,targetWidth,targetHeight){
					...
					switch (placement) {
			          ...
			          case 'right':
			            ...
			            break;
			          case 'top-right':
			            position = {top: pos.top - targetHeight -arrowSize, left: pos.left -2};
			            arrowOffset = {left: elementW /2 +5 };
			            break;
			          case 'top-left':
